...
(function($) {
  ...
  //Added 2/24 Menu
  function mainMenu(){
    $( ".menu-desktop li a" ).mouseenter(function() {
  ...
  $(document).ready(function() {
    ...
    //menu hover
    $( ".menu-desktop li" ).mouseenter(function() {
  ...
  //Call functions here
      ...
      headerSize();
  //SLICK SLIDER
    $(".slider-main--contentSlide a[href='#']").click(function(e) {
      e.preventDefault();
    });
    $(".slider-main--contentSlide a").filter(function() {
